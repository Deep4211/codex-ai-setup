...
description: Advanced swarm orchestration patterns for research, development, testing,
  and complex distributed workflows
---
...
npx ruflo@latest swarm "research AI trends in 2025" \
  --strategy research \
  --mode distributed \
  --max-agents 6 \
  --parallel \
...
npx ruflo@latest swarm "build REST API with authentication" \
...
```bash
# Quick testing swarm
npx ruflo@latest swarm "test application comprehensively" \
  --strategy testing \
  --mode star \
  --parallel \
  --timeout 600
