...
description: Comprehensive GitHub project management with swarm-coordinated issue
  tracking, project board automation, and sprint planning
---
...
npx ruflo@latest hooks pre-task --description "Feature implementation"
```
