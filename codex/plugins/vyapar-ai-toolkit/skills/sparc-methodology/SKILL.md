...
npx ruflo@latest sparc run <mode> "task description"
...
npx ruflo@latest sparc help <mode>

# Run with options
npx ruflo@latest sparc run <mode> "task" --parallel --monitor

# Execute TDD workflow
npx ruflo@latest sparc tdd "feature description"

# Batch execution
npx ruflo@latest sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx ruflo@latest sparc pipeline "task description"
```
...
```bash
# Before work
npx ruflo@latest hooks pre-task --description "implement auth"

# During work
npx ruflo@latest hooks post-edit --file "auth.js"

# After work
npx ruflo@latest hooks post-task --task-id "task-123"
```
...
npx ruflo@latest sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx ruflo@latest sparc run architect "design auth system"

# Step 3: TDD implementation
npx ruflo@latest sparc tdd "user authentication feature"

# Step 4: Code review
npx ruflo@latest sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx ruflo@latest sparc run documenter "document auth API"
```
...
npx ruflo@latest sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx ruflo@latest sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx ruflo@latest sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx ruflo@latest sparc run reviewer "validate bug fix"
```
...
npx ruflo@latest sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx ruflo@latest sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx ruflo@latest sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx ruflo@latest sparc run tester "performance benchmarks"
```
...
npx ruflo@latest sparc pipeline "e-commerce checkout feature"
...
# Full pipeline
npx ruflo@latest sparc pipeline "task"

# Batch execution
npx ruflo@latest sparc batch <modes> "task"
```
